...
func TestParseTypeOverrides(t *testing.T) {
	...
	p := New(SetOverrides(map[string]string{
		"github.com/xue-ding-e/swag/testdata/global_override/types.Application":  "string",
		"github.com/xue-ding-e/swag/testdata/global_override/types.Application2": "github.com/xue-ding-e/swag/testdata/global_override/othertypes.Application",
		"github.com/xue-ding-e/swag/testdata/global_override/types.ShouldSkip":   "",
	}))
	err := p.ParseAPI(searchDir, mainAPIFile, defaultParseDepth)
	assert.NoError(t, err)
...
func TestParser_skipPackageByPrefix(t *testing.T) {
	...
	assert.False(t, parser.skipPackageByPrefix("github.com/xue-ding-e/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/xue-ding-e/swag/cmd"))
	assert.False(t, parser.skipPackageByPrefix("github.com/xue-ding-e/swag/gen"))

	parser = New(SetPackagePrefix("github.com/xue-ding-e/swag/cmd"))

	assert.True(t, parser.skipPackageByPrefix("github.com/xue-ding-e/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/xue-ding-e/swag/cmd"))
	assert.True(t, parser.skipPackageByPrefix("github.com/xue-ding-e/swag/gen"))

	parser = New(SetPackagePrefix("github.com/xue-ding-e/swag/cmd,github.com/swaggo/swag/gen"))
